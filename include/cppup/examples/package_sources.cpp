...
extern "C" BuildConfiguration configure() {
    ...
    config.packages.push_back(
        Package::from_directory("embedded_lib", "third_party/embedded_lib")
    );
    ...
    Package eigen_zip("eigen", "3.4.0", "https://gitlab.com/libeigen/eigen/-/archive/3.4.0/eigen-3.4.0.zip", SourceType::ZIP);
    ...
    auto header_only_lib = Package::header_only("single_header_lib", "https://github.com/user/lib.git");
    ...
    Package subdir_pkg("protobuf", "3.21.12", "https://github.com/protocolbuffers/protobuf.git", SourceType::GIT, BuildSystem::CMAKE);
...
extern "C" BuildConfiguration configure_conditional() {
    ...
    if (get_env("CPPUP_USE_LOCAL_DEPS").has_value()) {
        ...
        config.packages.push_back(
            Package::from_directory("fmt", "../fmt")
        );
        config.packages.push_back(
            Package::from_directory("spdlog", "../spdlog")
        );
    } else {
...
extern "C" BuildConfiguration configure_monorepo() {
    ...
    Package llvm_pkg("llvm", "16.0.0", "https://github.com/llvm/llvm-project.git", SourceType::GIT, BuildSystem::CMAKE);
    ...
    Package qt_pkg("qt", "6.5.0", "https://code.qt.io/qt/qt5.git", SourceType::GIT, BuildSystem::CMAKE);
    qt_pkg.build_args = {
