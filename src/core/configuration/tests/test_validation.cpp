...
void test_package_validation() {
    ...
    BuildConfiguration invalid_config{
        .packages = {
    ...
    for (const auto& error : result.errors) {
        ...
        if (error.message.find("fmt") != std::string::npos && error.message.find("9.0.0") != std::string::npos) {
...
void test_source_validation() {
    ...
    BuildConfiguration warning_config{
        .sources = {
            "src/main.cpp",          // Valid
...
void test_output_validation() {
    ...
    BuildConfiguration valid_config{
        ...
        .libraries = {
            Library{"mylib", {"src/utils.cpp"}}
        },
        .tests = {
            Test{"mytests", {"tests/test_main.cpp"}}
        }
    };
    ...
    BuildConfiguration empty_sources_config{
        .binaries = {
