...
std::expected<void, std::string> HeaderOnlyPackage::build(const std::filesystem::path& source_path) const {
...
std::vector<std::string> HeaderOnlyPackage::find_header_directories(const std::filesystem::path& source_path) const {
    std::vector<std::string> include_paths;
    
    // Common header directory names
    std::vector<std::string> possible_dirs = {
        "include", "src", "headers", "single_include", "."
    };
