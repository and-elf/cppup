...
int main()
{
  ...
  try
  {
    ...
    std::cout << "✓ Package listing successful (" << list_result->size() << " packages)"
              << std::endl;
    ...
    {
      std::cout << "✗ Manager package installation failed: " << manager_install_result.error()
                << std::endl;
    ...
    std::cout << "✓ Manager package listing successful (" << manager_list_result->size()
              << " packages)" << std::endl;
