...
extern "C" BuildConfiguration configure()
{
  ...
  config.libraries.push_back(Library{
      ...
      .sources    = {"cli_application.cpp", "logger.cpp", "commands.cpp", "commands/common.cpp",
                     "commands/init.cpp", "commands/build.cpp", "commands/clean.cpp",
                     "commands/compile_commands_cmd.cpp", "commands/test.cpp",
                     "commands/format.cpp", "commands/tidy.cpp", "commands/source_selection.cpp",
                     "commands/package.cpp", "commands/module.cpp", "commands/toolchain.cpp",
                     "commands/plugin.cpp", "commands/update.cpp"},
