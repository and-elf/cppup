...
extern "C" BuildConfiguration configure()
{
  ...
  config.libraries.push_back(
      Library{"cppup_config",
              {"src/core/configuration/compiler.cpp", "src/core/configuration/compile_commands.cpp",
               "src/core/configuration/loader.cpp", "src/core/configuration/validation.cpp",
  ...
  config.libraries.push_back(
      Library{"cppup_dependency", {"src/core/dependency/database.cpp"}, LibraryType::Static});
  ...
  config.libraries.push_back(Library{
      "cppup_cli",
      {"src/core/cli/cli_application.cpp", "src/core/cli/logger.cpp", "src/core/cli/commands.cpp",
       "src/core/cli/commands/common.cpp", "src/core/cli/commands/init.cpp",
       "src/core/cli/commands/build.cpp", "src/core/cli/commands/compile_commands_cmd.cpp",
